...
The `CSGo` package still doesn't have released on CRAN, but you can use the development version from [GitHub](https://github.com/adsoncostanzifilho/CSGo) with:
